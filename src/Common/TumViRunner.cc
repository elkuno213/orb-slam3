...
TumViRunner::TumViRunner(const RunConfig& config)
  ...
  , _inertial(_sensor == System::Sensor::IMU_MONOCULAR || _sensor == System::Sensor::IMU_STEREO)
  , _is_stereo(_sensor == System::Sensor::STEREO || _sensor == System::Sensor::IMU_STEREO)
